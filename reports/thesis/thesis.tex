...
for finding its solution. More information on linear programming and
...
\cite{rabiner1989tutorial} where $N$ is the number of nodes in a frame and $T$
is the number of frames: this algorithm is known as the Viterbi algorithm
\cite{forney1973viterbi}.

\subsection{Classification}

% Some missing text needs to be inserted...
...
and their $p$ variances. The resulting variable with the highest variance will
have the maximum variance acheivable, under some constraints that will be
explained shortly. 
