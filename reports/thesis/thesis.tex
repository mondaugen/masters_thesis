...
enough unique atoms for equation for Equation~\ref{eq:ddmsyseq}. These bins
...
times have between determined as connected, we can write a system of equations
...
\]
i.e., the average of the two measured coefficients. Finally we require
\[
    \phi \left( H \right)
    =
