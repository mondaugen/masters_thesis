...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_orig_data_plot_title}.txt}
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_orig_spur_data_plot_title}.txt}}{Line-segments describing the frequency and frequency modulation
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_class_pcs_plot_title}.txt}}{The PCs for each theoretical analysis time-point. $\mu_{i}^{0}$ and
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_source_1_est_plot_title}.txt}}{Line-segments classified as belonging to Source 1. The
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_source_2_est_plot_title}.txt}}{Line-segments classified as belonging to Source 2. See
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_smooth_freq_amp_sol_plot_title}.txt}}{The points originally classified as source 1 are marked with
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_source_1_smooth_freq_plot_title}.txt}}{Line-segments classified as belonging to source 1 after smoothing
        in frequency.
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_source_2_smooth_freq_plot_title}.txt}}{Line-segments classified as belonging to source 2 after smoothing
        in frequency.
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_source_1_smooth_amp_plot_title}.txt}}{Line-segments classified as belonging to source 1 after smoothing
        in amplitude.
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_source_2_smooth_amp_plot_title}.txt}}{Line-segments classified as belonging to source 2 after smoothing
        in amplitude.
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{hsrp_test_7_multi_af_plot_title}.txt}}{ Line-segments representing the instantaneous amplitude and amplitude slope at
...
\begin{figure}[!t]
    ...
    \CaptionWithTitle{\input{plots/{ad_hoc_cluster_part_ex_plot_title}.txt}}{The data points are convolved with some smoothing kernels giving a
