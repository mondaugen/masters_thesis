...
\subsection{Results for $\psi_{no} = \omega_{no} = \alpha_{no} = 1
\times 10^{-3}$ and $A_{no} = 1 \times 10^{-5}$}
        
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_orig_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
    of both sources.\label{plot:hsrp_test_7_0.001_0.00001_plot_orig_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_orig_spur_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
        of the original data and the spurious data.
    \label{plot:hsrp_test_7_0.001_0.00001_plot_orig_spur_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_class_pcs}.eps}
    ...
    \label{plot:hsrp_test_7_0.001_0.00001_plot_class_pcs}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_source_1_est}.eps}
    \caption{Line-segments classified as belonging to Source 1. The
        ...
        Figure~\ref{plot:hsrp_test_7_0.001_0.00001_plot_class_pcs} is not predictible.
    \label{plot:hsrp_test_7_0.001_0.00001_plot_source_1_est}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_source_2_est}.eps}
    \caption{Line-segments classified as belonging to Source 2. See
        Figure~\ref{plot:hsrp_test_7_0.001_0.00001_plot_source_2_est} for more
        information.
    \label{plot:hsrp_test_7_0.001_0.00001_plot_source_2_est}}
\end{figure}

As seen in Figure~\ref{plot:hsrp_test_7_0.001_0.00001_plot_source_1_est} and
\ref{plot:hsrp_test_7_0.001_0.00001_plot_source_2_est}, while
...
Figure~\ref{plot:hsrp_test_7_0.001_0.00001_smooth_freq_amp_sol}.
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_smooth_freq_amp_sol}.eps}
    ...
    \label{plot:hsrp_test_7_0.001_0.00001_smooth_freq_amp_sol}}
\end{figure}
The estimated sources after smoothing in frequency are shown in
Figures~\ref{plot:hsrp_test_7_0.001_0.00001_source_1_smooth_freq}~and~\ref{plot:hsrp_test_7_0.001_0.00001_source_2_smooth_freq}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_source_1_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.001_0.00001_source_1_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_source_2_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.001_0.00001_source_2_smooth_freq}}
\end{figure}
The estimated sources after smoothing in amplitude are shown in
Figures~\ref{plot:hsrp_test_7_0.001_0.00001_source_1_smooth_amp}~and~\ref{plot:hsrp_test_7_0.001_0.00001_source_2_smooth_amp}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_source_1_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.001_0.00001_source_1_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_source_2_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.001_0.00001_source_2_smooth_amp}}
\end{figure}
...
Figures~\ref{plot:hsrp_test_7_0.001_0.00001_plot_orig_data} we see that at around
...
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.00001_plot_af}.eps}
    \caption{ Line-segments representing the instantaneous amplitude and amplitude slope at
        analysis time points. 
    \label{plot:hsrp_test_7_0.001_0.00001_af}}
\end{figure}
In Figure~\ref{plot:hsrp_test_7_0.001_0.00001_af} we see that the amplitudes of
...
\subsection{Results for $\psi_{no} = \omega_{no} = \alpha_{no} = 1
\times 10^{-3}$ and $A_{no} = 1 \times 10^{-4}$}
        
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_orig_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
    of both sources.\label{plot:hsrp_test_7_0.001_0.0001_plot_orig_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_orig_spur_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
        of the original data and the spurious data.
    \label{plot:hsrp_test_7_0.001_0.0001_plot_orig_spur_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_class_pcs}.eps}
    \caption{The PCs for each theoretical analysis time-point. $\mu_{i}^{0}$ and
        $\sigma_{i}^{0}$ are respectively
    the initial mean and standard deviation guesses for the EM algorithm fitting
    the GMM parameters to the $i$th source. These values are also visible on the
    ...
    Section~\ref{sec:amfmseppreparecluster} are included for comparison. The
    plot is of a subsection of the analysis to better show the process.
    \label{plot:hsrp_test_7_0.001_0.0001_plot_class_pcs}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_source_1_est}.eps}
    \caption{Line-segments classified as belonging to Source 1. The
        classification is done on each frame so classifications in consecutive
        frames may not belong to the same true source. This is because the
        ordering of the clusters in each frame in
        Figure~\ref{plot:hsrp_test_7_0.001_0.0001_plot_class_pcs} is not predictible.
    \label{plot:hsrp_test_7_0.001_0.0001_plot_source_1_est}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_source_2_est}.eps}
    \caption{Line-segments classified as belonging to Source 2. See
        Figure~\ref{plot:hsrp_test_7_0.001_0.0001_plot_source_2_est} for more
        information.
    \label{plot:hsrp_test_7_0.001_0.0001_plot_source_2_est}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_smooth_freq_amp_sol}.eps}
    \caption{The points originally classified as source 1 are marked with
        circles and those originally classified as source 2 squares. The paths
        in black or grey connect the points for source 1 or source 2
        respectively with optimal smoothness.
    \label{plot:hsrp_test_7_0.001_0.0001_smooth_freq_amp_sol}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_source_1_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.001_0.0001_source_1_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_source_2_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.001_0.0001_source_2_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_source_1_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.001_0.0001_source_1_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_source_2_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.001_0.0001_source_2_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.001_0.0001_plot_af}.eps}
    \caption{ Line-segments representing the instantaneous amplitude and amplitude slope at
        analysis time points. 
    \label{plot:hsrp_test_7_0.001_0.0001_af}}
\end{figure}

\subsection{Results for $\psi_{no} = \omega_{no} = \alpha_{no} = 1
\times 10^{-2}$ and $A_{no} = 1 \times 10^{-5}$}
        
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_orig_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
    of both sources.\label{plot:hsrp_test_7_0.01_0.00001_plot_orig_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_orig_spur_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
        of the original data and the spurious data.
    \label{plot:hsrp_test_7_0.01_0.00001_plot_orig_spur_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_class_pcs}.eps}
    \caption{The PCs for each theoretical analysis time-point. $\mu_{i}^{0}$ and
        $\sigma_{i}^{0}$ are respectively
    the initial mean and standard deviation guesses for the EM algorithm fitting
    the GMM parameters to the $i$th source. These values are also visible on the
    ...
    Section~\ref{sec:amfmseppreparecluster} are included for comparison. The
    plot is of a subsection of the analysis to better show the process.
    \label{plot:hsrp_test_7_0.01_0.00001_plot_class_pcs}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_source_1_est}.eps}
    \caption{Line-segments classified as belonging to Source 1. The
        classification is done on each frame so classifications in consecutive
        frames may not belong to the same true source. This is because the
        ordering of the clusters in each frame in
        Figure~\ref{plot:hsrp_test_7_0.01_0.00001_plot_class_pcs} is not predictible.
    \label{plot:hsrp_test_7_0.01_0.00001_plot_source_1_est}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_source_2_est}.eps}
    \caption{Line-segments classified as belonging to Source 2. See
        Figure~\ref{plot:hsrp_test_7_0.01_0.00001_plot_source_2_est} for more
        information.
    \label{plot:hsrp_test_7_0.01_0.00001_plot_source_2_est}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_smooth_freq_amp_sol}.eps}
    \caption{The points originally classified as source 1 are marked with
        circles and those originally classified as source 2 squares. The paths
        in black or grey connect the points for source 1 or source 2
        respectively with optimal smoothness.
    \label{plot:hsrp_test_7_0.01_0.00001_smooth_freq_amp_sol}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_source_1_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.01_0.00001_source_1_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_source_2_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.01_0.00001_source_2_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_source_1_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.01_0.00001_source_1_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_source_2_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.01_0.00001_source_2_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.00001_plot_af}.eps}
    \caption{ Line-segments representing the instantaneous amplitude and amplitude slope at
        analysis time points. 
    \label{plot:hsrp_test_7_0.01_0.00001_af}}
\end{figure}

\subsection{Results for $\psi_{no} = \omega_{no} = \alpha_{no} = 1
\times 10^{-2}$ and $A_{no} = 1 \times 10^{-4}$}
        
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_orig_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
    of both sources.\label{plot:hsrp_test_7_0.01_0.0001_plot_orig_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_orig_spur_data}.eps}
    \caption{Line-segments describing the frequency and frequency modulation
        of the original data and the spurious data.
    \label{plot:hsrp_test_7_0.01_0.0001_plot_orig_spur_data}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_class_pcs}.eps}
    \caption{The PCs for each theoretical analysis time-point. $\mu_{i}^{0}$ and
        $\sigma_{i}^{0}$ are respectively
    the initial mean and standard deviation guesses for the EM algorithm fitting
    the GMM parameters to the $i$th source. These values are also visible on the
    ...
    Section~\ref{sec:amfmseppreparecluster} are included for comparison. The
    plot is of a subsection of the analysis to better show the process.
    \label{plot:hsrp_test_7_0.01_0.0001_plot_class_pcs}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_source_1_est}.eps}
    \caption{Line-segments classified as belonging to Source 1. The
        classification is done on each frame so classifications in consecutive
        frames may not belong to the same true source. This is because the
        ordering of the clusters in each frame in
        Figure~\ref{plot:hsrp_test_7_0.01_0.0001_plot_class_pcs} is not predictible.
    \label{plot:hsrp_test_7_0.01_0.0001_plot_source_1_est}}
\end{figure}

\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_source_2_est}.eps}
    \caption{Line-segments classified as belonging to Source 2. See
        Figure~\ref{plot:hsrp_test_7_0.01_0.0001_plot_source_2_est} for more
        information.
    \label{plot:hsrp_test_7_0.01_0.0001_plot_source_2_est}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_smooth_freq_amp_sol}.eps}
    \caption{The points originally classified as source 1 are marked with
        circles and those originally classified as source 2 squares. The paths
        in black or grey connect the points for source 1 or source 2
        respectively with optimal smoothness.
    \label{plot:hsrp_test_7_0.01_0.0001_smooth_freq_amp_sol}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_source_1_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.01_0.0001_source_1_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_source_2_smooth_freq}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in frequency.
    \label{plot:hsrp_test_7_0.01_0.0001_source_2_smooth_freq}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_source_1_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 1 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.01_0.0001_source_1_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_source_2_smooth_amp}.eps}
    \caption{Line-segments classified as belonging to source 2 after smoothing
        in amplitude.
    \label{plot:hsrp_test_7_0.01_0.0001_source_2_smooth_amp}}
\end{figure}
\begin{figure}
    %\centering
    \includegraphics[width=\textwidth]{plots/{hsrp_test_7_0.01_0.0001_plot_af}.eps}
    \caption{ Line-segments representing the instantaneous amplitude and amplitude slope at
        analysis time points. 
    \label{plot:hsrp_test_7_0.01_0.0001_af}}
\end{figure}
