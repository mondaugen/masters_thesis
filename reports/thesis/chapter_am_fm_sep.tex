...
%\begin{figure}[t]
%    \centering
%\includegraphics[width=\chapamfmsepfigwidthscale\textwidth]{/home/sandman/Documents/development/masters_thesis/experiment_1/plots/time_frequency_spurious.ps}
%\end{figure}
...
most NMF or PLCA implementations\footnote{See \cite{bronson2015exploration} for
