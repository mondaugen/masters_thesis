\chapter{Partial Tracking\label{sec:partialtracking}}
...
other paths may be comprimised under this criterion.

In \cite{mcaulay1986speech} the parameters are the instantaneous amplitude,
...
\section{Partial paths on example signal\label{sec:mq_lp_compare_chirp}}
