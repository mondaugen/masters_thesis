...
\subsection{Evaluation on sinusoid of cubic phase and quartic amplitude \label{sec:evalcubicphase}}
\begin{table}
...
\begin{figure}[!t]
    ...
    }{This shows the error of the interpolated amplitude functions when compared
    with the original amplitude function for the three proposed methods.
