...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\figwidthscale\textwidth]{plots/mq_cubic_error.eps}
    \caption{
...
%\begin{figure}[!t]
%    \centering
%    \includegraphics[width=\figwidthscale\textwidth]{plots/mq_mod_cubic_original_spec.eps}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\figwidthscale\textwidth]{plots/mq_mod_cubic_error.eps}
...
%\begin{figure}[!t]
%    \centering
%    \includegraphics[width=\figwidthscale\textwidth]{plots/mq_mod_quintic_original_spec.eps}
%    \caption{This depicts the dB spectrum. Darker regions represent greater
%        values whereas lighter are smaller values.
%    \label{plot:mqmodcubicoriginalspec}}
%\end{figure}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\figwidthscale\textwidth]{plots/mq_mod_quintic_error.eps}
    \caption{The error when subtracting the original signal from the estimated
...
interpolation method works superiorly for the signal model considered. The
...
lower-order amplitude function and higher-order phase function. The possibility
